...
Hypothesis: long-short z-score dynamically risk weighted time series momentum.
'''
...
class alpha_002:
    ...
    def run(self):
        ...
        # Convert raw signal to z-score
        self.z_score_signal = self.raw_signal.apply(lambda x: alpha_utils.z_score(x), axis=1)
